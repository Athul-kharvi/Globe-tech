...
export default function VisionMission() {
  return (
    <section className="bg-orange-500 py-20 px-6 md:px-12 lg:px-20 h-auto">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <motion.div
            ...
            className="max-w-80 p-6 bg-white border border-gray-200 rounded-3xl shadow-sm"
          >
            {/* Eye Icon */}
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="size-6 mb-3 text-black"
            >
              <path
                strokeLinecap="round"
            ...
            <a href="#">
              <motion.h5
                ...
                className="mb-2 text-2xl font-semibold tracking-tight text-customBlack"
              >
                Vision
              </motion.h5>
            </a>
          ...
          <motion.div
            ...
            className="max-w-96 p-6 bg-white  border border-gray-200 rounded-3xl shadow-sm">


            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 mb-3 text-black">
