...
const blogList = [
  {
    id: 1,
    title: "Advancing Precision: How Fortune Indo Corp Leads the Future of CNC Machining in India",
    date: "April 10, 2025",
    summary:
  ...
  {
    id: 2,
    title: "The Importance of Heat Treatment in Manufacturing: How Fortune Indo Corp Delivers Enhanced Performance and Durability",
    date: "April 5, 2025",
    summary:
          ...
          {blogList.map((blog) => (
            ...
            >
              ...
              <div className="p-6 space-y-2">
                ...
                <p className="text-gray-700 font-ftregolaneue">{blog.summary}</p>
